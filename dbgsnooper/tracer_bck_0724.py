...
class Tracer:
    ...
    def __init__(self, output=None, watch=(), watch_explode=(), depth=1,
                 ...
                 color=True, observed_file = None, start_line = None, end_line = None, loop = 3, depth_expanded = True, call_graph_output_path = None):
        # call_graph_output_path = '/data/swe-fl/SRC/pysnooper_axel/trace_test/test.json'
